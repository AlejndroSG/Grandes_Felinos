...
<body id="team">
    ...
    <main>
        <section id="miembros-equipo" class=" py-5 container">
            <h1 class="text-center mb-5">Nuestro Equipo</h1>
            <div class="row g-4">
                <div class="col-md-6 my-3 text-center text-white border border-white rounded py-5">
                    <img src="./fotos/equipo/1.jpg" class="rounded-circle mb-3" alt="Miembro 1">
                    <h5>Rachid Piñero</h5>
                    <p class="text-danger">Diseñador Web</p>
                    <p>"Apasionado por crear experiencias visuales únicas."</p>
                </div>
                <div class="col-md-6 my-3 text-center text-white border border-white rounded py-5">
                    <img src="./fotos/equipo/2.jpg" class="rounded-circle mb-3" alt="Miembro 2">
                    <h5>Maria Pino</h5>
                    <p class="text-danger">Desarrolladora</p>
                    <p>"Convirtiendo ideas en soluciones funcionales."</p>
                </div>
                <div class="col-md-6 my-3 text-center text-white border border-white rounded py-5">
                    <img src="./fotos/equipo/3.jpg" class="rounded-circle mb-3" alt="Miembro 3">
                    <h5>Cesar Olivera</h5>
                    <p class="text-danger">Gerente de Proyecto</p>
                    <p>"Liderando proyectos con pasión y eficacia."</p>
                </div>
                <div class="col-md-6 my-3 text-center text-white border border-white rounded py-5">
                    <img src="./fotos/equipo/4.jpg" class="rounded-circle mb-3" alt="Miembro 4">
                    <h5>Anais Verdu</h5>
                    <p class="text-danger">Artista Digital</p>
                    <p>"Convirtiendo ideas en visuales impactantes."</p>
                </div>
                <div class="col-md-6 my-3 text-center text-white border border-white rounded py-5">
                    <img src="./fotos/equipo/5.jpg" class="rounded-circle mb-3" alt="Miembro 5">
                    <h5>Lorenzo Castañeda</h5>
                    <p class="text-danger">Fotógrafo</p>
                    <p>"Capturando momentos extraordinarios."</p>
                </div>
                <div class="col-md-6 my-3 text-center text-white border border-white rounded py-5">
                    <img src="./fotos/equipo/6.jpg" class="rounded-circle mb-3" alt="Miembro 6">
                    <h5>Cristian San-Jose</h5>
                    <p class="text-danger">Coordinador de equipo de grabación</p>
                    <p>"Trabajando en equipo para crear contenido impactante."</p>
                </div>
            </div>
        </section>

        <section id="proceso-trabajo" class="container  py-5 my-0">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="mb-4">Nuestro Proceso</h2>
                    <p class="fs-5 text-white">Desde la idea inicial hasta el resultado final, trabajamos de manera colaborativa y estratégica para alcanzar nuestros objetivos.</p>
                    <div class="row g-4 text-center mt-4">
                        <div class="col-md-9 contenido">
                            <div class="card text-light p-3 p-md-5">
                                <h5 class="text-danger fs-3">Investigación y Análisis</h5>
                            ...
                            <div class="card text-light p-3 p-md-5">
                                <h5 class="text-danger fs-3">Planificación Estratégica</h5>
                            ...
                            <div class="card text-light p-3 p-md-5">
                                <h5 class="text-danger fs-3">Implementación en Terreno</h5>
                            ...
                            <div class="card text-light p-3 p-md-5">
                                <h5 class="text-danger fs-3">Monitoreo y Divulgación</h5>
                        ...
                        <div class="col-md-3 botones">
                            <button class="active text-white my-4 rounded-5 p-3">1</button>
                            <button class="active text-white my-4 rounded-5 p-3">2</button>
                            <button class="active text-white my-4 rounded-5 p-3">3</button>
                            <button class="active text-white my-4 rounded-5 p-3">4</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="logros-reconocimientos" class=" py-5 container my-0">
        ...
        <section class="container-fluid  py-5" id="unete-iniciativas">
